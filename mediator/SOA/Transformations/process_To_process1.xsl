   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            ...
            <oracle-xsl-mapper:rootElement name="process" namespace="http://xmlns.oracle.com/AnuAnnaSOAApplication/WebServiceA/BPELProcessWSA"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [WED SEP 29 07:14:18 IST 2021].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <ns0:process>
         <ns0:Custid>
            <xsl:value-of select="/ns0:process/ns0:Custid"/>
         </ns0:Custid>
      </ns0:process>
   </xsl:template>
</xsl:stylesheet>
